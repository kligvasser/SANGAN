...
def get_arguments():
    ...
    parser.add_argument('--dis-model', default='d_vanilla', help='discriminator architecture (default: vanilla)')
    parser.add_argument('--gen-model-config', default='', help='additional architecture configuration')
    parser.add_argument('--dis-model-config', default='', help='additional architecture configuration')
    ...
    parser.add_argument('--hinge-margin', default=1., type=float, help='hinge loss margin (default: 1.0)')
    ...
    parser.add_argument('--adversarial-weight', default=0, type=float, help='adversarial-weight (default: 0)')
    ...
    parser.add_argument('--use-tensorboard', default=False, action='store_true', help='use tensorboardx (default: false)')
