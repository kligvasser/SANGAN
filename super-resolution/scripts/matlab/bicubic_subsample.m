...
input_folder = '/media/klig/hd/datasets/sr/ex/calcalist/img';
save_mod_folder = '/media/klig/hd/datasets/sr/ex/calcalist/img_mod';
save_LR_folder = '/media/klig/hd/datasets/sr/ex/calcalist/img_x4';
% save_bic_folder = '';
